...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config, CorsRegistry cors) {
        ...
        //disabled Http methods for products : put,post and delete because we just want to get updates for product page no product
        // should be deleted, updated or added in product list
